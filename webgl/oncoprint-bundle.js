	...
	var renderTrack = function(cell_view, model, track_id) {
    	...
    	for (var i=0; i<shape_list_list.length; i++) 
    	{
    		if(shape_list_list[i][0].type === "rectangle" )
    		{
    			...
    			var left = Number(shape_list_list[i][0].x);
    			var right = Number(shape_list_list[i][0].x) + Number(shape_list_list[i][0].height);
    			var low = Number(shape_list_list[i][0].y);
    			var high = Number(shape_list_list[i][0].y) + Number(shape_list_list[i][0].width);
